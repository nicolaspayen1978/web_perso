...
// 🔁 KV helper to fetch previous gallery
...
async function kvSet(key, value) {
  ...
  if (!res.ok) console.error(`❌ KV set failed:`, out);
}
...
export default async function updateGallery() {
  ...
  let previous = await kvGet('gallery:json');
